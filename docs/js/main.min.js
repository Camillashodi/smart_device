...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  var textButton = document.querySelector('[data-text-btn]');
  var deskText = document.querySelector('[data-desk-text]');
  ...
  var footerContents = document.querySelectorAll('[data-footer-content]');
  var footerHeaders = document.querySelectorAll('[data-footer-header]');
  ...
  if (toggles.length !== 0) {
    ...
    var removeClassIsOpen = function removeClassIsOpen(elements) {
    ...
    footerHeaders.forEach(function (header) {
      header.addEventListener('click', function () {
        var headerDataset = header.dataset.footerHeader;
        var activeToggle = document.querySelector("[data-toggle=".concat(headerDataset, "]"));
        var activeContent = document.querySelector("[data-footer-content=".concat(headerDataset, "]"));
  ...
  var inputs = document.querySelectorAll('[data-input-phone]');
  ...
  var modalButton = document.querySelector('[data-open-modal]');
  var inputName = document.querySelector('[data-input-name]');
